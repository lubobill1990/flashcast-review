...
export type SampleOutput = ThenArg<ReturnType<typeof factory.sampleOutputService.getUserSampleOutputById>>;

export async function getUser() {
  return factory.userService.getUser();
}

export async function getUserSampleOutputById(userId: number, sampleOutputId: number) {
  return factory.sampleOutputService.getUserSampleOutputById(userId, sampleOutputId);
}
