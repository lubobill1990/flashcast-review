...
import { MainPageCard, Textarea, Label, Field, Button, Divider } from 'portal-ui';
    ...
    <>
      ...
      <MainPageCard activePage='start_generating'>
        <Label style={{fontSize: '16px'}}>
          Upload recording file, transcript and AI notes from Meeting recap to generate short clips that capture the key meeting moments and summaries.
        </Label>
        <form action={handleSubmit} style={{marginTop: '16px'}}>
          ...
          <div style={{ display: 'flex', justifyContent: 'right' }}>
            <Button
              appearance='primary'
              type='submit'
              style={{background: 'linear-gradient(99.14deg, #499DFF -17.23%, #5E64FF 41.03%, #E64EFF 150.75%)'}}
            >
